# ====================================================================================
# Setup Project
PROJECT_NAME := provider-scalabilityprovider
...
IMAGES = provider-scalabilityprovider
...
XPKGS = provider-scalabilityprovider
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-scalabilityprovider: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider ScalabilityProvider CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider ScalabilityProvider controllers
...
# This target prepares repo for your provider by replacing all "scalabilityprovider"
